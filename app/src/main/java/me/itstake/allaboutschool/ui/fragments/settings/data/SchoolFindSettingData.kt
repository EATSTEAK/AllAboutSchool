...
class SchoolFindSettingData(override val settingEnum: SettingEnums, override var settingValue: String, override val iconId: Int?, override val localizedTitle: String, override val localizedDetails: String): SettingData<String> {
