...
class MealsPagerAdapter(fragmentManager: FragmentManager, private val dataset: List<Meal>): FragmentStatePagerAdapter(fragmentManager, BEHAVIOR_RESUME_ONLY_CURRENT_FRAGMENT) {
    ...
    override fun getCount(): Int = if(dataset == null || dataset.isEmpty()) 1 else dataset.size
